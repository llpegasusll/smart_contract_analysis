...
solidity_files_path = "C:\\Users\\stanl\\Desktop\\praccc\\sample"
...
def run_slither(file_path, solc_version):
    ...
    # try:
    output_file = "C:\\Users\\stanl\\Desktop\\praccc\\sltroutput.json"
    ...
    if os.path.exists(output_file):
        ...
        print(f"Slither did not generate the expected output file {output_file} for {file_path} ")#{detector}")
# except Exception as e:
...
with open("slither_data.json", "w") as f:
